...
VALUES ('IMPORTEXPORT_MANAGEMENT','importexport.adminFeature.importdata_management.name',2,'jsp/admin/plugins/importexport/ManageImportData.jsp','importexport.adminFeature.importdata_management.description',0,'importexport','CONTENT','images/admin/skin/plugins/importexport/importexport.png', '');

--
-- Init  table core_user_right
--
INSERT INTO core_user_right (id_right,id_user) VALUES ('IMPORTEXPORT_MANAGEMENT',1);
